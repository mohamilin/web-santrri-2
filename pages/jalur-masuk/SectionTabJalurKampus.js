...
export default function SectionTabJalurKampus({ jalurMasuk }) {
  ...
  const [faculties, setFaculties] = React.useState(jalurMasuk?.faculty);
      ...
      <TabContext value={value}>
        ...
        <TabPanel value="1">
          <Box>
            <H3>Deskripsi</H3>
            <div
              dangerouslySetInnerHTML={{ __html: jalurMasuk?.description }}
            />
          </Box>
        </TabPanel>
        <TabPanel value="2">
        ...
        <TabPanel value="3">
          <Box>
            ...
            <Grid container spacing={2}>
              {jalurMasuk?.campuses?.map((i, index) => (
