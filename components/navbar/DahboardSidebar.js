...
import {
  ...
  ChevronLeftIcon,
  ListIconWrapper,
} from "@/layouts/LayoutStyledComponents";
import SidebarAccordion from "@/layouts/SidebarAccordion";
import Scrollbar from "../Scrollbar";
import { navigationsDahboard } from "@/utils/constants/menu/navigationsDahboard";
...
export default function DahboardSidebar(props) {
  const {
    sidebarCompact,
    showMobileSideBar,
  ...
  const content = (
    ...
    >
      <NavWrapper compact={sidebarCompact}>
        {renderLevels(navigationsDahboard.student)}
      </NavWrapper>
    </Scrollbar>
  );
